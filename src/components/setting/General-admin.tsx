...
function GeneralAdmin({
    ...
    return (
        <>
            <div className=' h-8/10 w-8/10 sm:h-7/10 sm:w-7/10 absolute top-1/6 left-1/8 z-0 bg-zinc-900 rounded-2xl border border-black border-solid shadow-xl flex flex-col sm:space-y-10 space-y-15'>
...
// return (
//     <>
//         <div className='absolute top-0 z-1 h-8/10 w-8/10 bg-zinc-900 rounded-2xl border border-black border-solid shadow-xl flex flex-col sm:space-y-10 space-y-15'>
//             <div className='w-9/10 h-25 mx-auto flex items-center border-b border-solid border-[rgba(255,255,255,0.1)] px-5'>
//                 <h1 className='capitalize text-4xl '>settings</h1>
//             </div>
//             <div className='w-8/10 sm:h-20 h-fit mx-auto flex flex-col items-start space-y-3 capitalize'>
